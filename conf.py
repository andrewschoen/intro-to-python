# -*- coding: utf-8 -*-
#
# Intro to Python documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'IntrotoPython', u'Intro to Python Documentation',
   u'Andrew Schoen', 'IntrotoPython', 'One line description of project.',
   'Miscellaneous'),
]
